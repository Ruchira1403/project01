...
<link rel="stylesheet" href="instructor.notifications.css">
<div class="main-content">
  <div class="page-header" >
    
  <div class="page-header1" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <h1 style="margin:0; font-size:2.5em; font-weight:300;">🔔 Notifications</h1>
    <p style="margin:10px 0 0 0; opacity:0.9; font-size:1.1em;">Stay updated with important announcements and reminders</p>
